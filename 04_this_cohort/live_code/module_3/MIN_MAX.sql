...
*/
SELECT 
product_name, max(original_price) as most_expensive
...
SELECT DISTINCT
product_name, -- product name from product
original_price
...
SELECT
product_qty_type -- coming from product TABLE
,MIN(original_price) as lowest_priced
...
product_name
,product_qty_type -- coming from product TABLE
,original_price as lowest_priced

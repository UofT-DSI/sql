...
p.*,
cp.product_id as product_id_in_cust_purchases_tbl

FROM product_category as pc
INNER JOIN product as p -- will give us product_name, product_size, product_qty_type
	ON pc.product_category_id = p.product_category_id
LEFT JOIN customer_purchases as cp -- by making this a left join, we are joining products that have not been sold

...
class: left, top, inverse
# Run SQLite in python and/or R
renderthis::to_pdf("~/Documents/GitHub/02-intro_sql/04_cohort_three/custom_slides/markdown/slides_04.Rmd")
### Python Example
...
```{r echo=FALSE}
#library(renderthis)
#renderthis::to_pdf("~/Documents/GitHub/02-intro_sql/04_cohort_three/custom_slides/markdown/slides_06.Rmd")
```
...
- Have a 5 year old Samoyed named Alto who takes up a lot of my free time `r structure("\U1F449", class = "emoji")`
]

.pull-right[

<img src="imgs/01_float_alto.png"
     height="400px"
...
.center[ 
<img src="imgs/01_data-lakehouse-new.png" 
  height="450px";>

<sup><sup><sup><sup> Image: Databricks, 2020 </sup></sup></sup></sup>
]
...
.pull-right.w40[
  ...
  <img src="imgs/01_na_capitals.png"
      height="450px"
...
<img src="imgs/01_euro_status.png" 
  height="300px";>
...
.pull-right[
<img src="imgs/01_farmers_market_cm.png"
     height="400px";
...
.pull-right.w35[
<img src="imgs/01_farmers_market_lm.png"
     height="300px";
     style="position:absolute; right:50px; top:250px;">
]
...
.pull-right[
<img src="imgs/01_farmers_market_pm.png"
     height="225px";
...
- Our (partial) Farmers Market database: 
  ...
  - vendor_inventory requires a composite key!
      - **why? which columns are required?** <br> `r structure("\U1F4AD", class = "emoji")``r structure("\U1F4AC", class = "emoji")`**Think, Pair, Share**

]

.pull-right[
<img src="imgs/01_farmers_market_composite_key.png"
     height="200px";
     style="position:absolute; right:50px; top:350px;">
]
...
#renderthis::to_pdf("~/Documents/GitHub/02-intro_sql/04_this_cohort/custom_slides/markdown/slides_01.html")
```
...
# About Us (James)
.pull-left[
- UofT Engineering undergrad and master `r structure("\U1F9AB", class = "emoji")`
- Licensed engineer in an oil & gas company sending robots into pipelines `r structure("\U1F918", class = "emoji")`
- DSI cohort 3
- Self-taught woodworking hobbyist `r structure("\U1FA9A", class = "emoji")`
- Real hobbies: motorcycle `r structure("\U1F6F5", class = "emoji")`, leisure skating `r structure("\U26F8", class = "emoji")`, camping `r structure("\U26FA", class = "emoji")`
]

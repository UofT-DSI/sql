...
- Navigate to your farmersmarket.db 
	...
	- ![db_browser_for_sqlite_choose_db.png](./images/db_browser_for_sqlite_choose_db.png)
...
![db_browser_for_sqlite.png](./images/db_browser_for_sqlite.png)
...
Switch to the Browse Data tab, booth is selected by default
 <img src="./images/the_browse_data_tab.png" width="900"> 


Using the table drop down at the top left, explore some of the contents of the database
 <img src="./images/the_table_drop_down_at_the_top_left.png" width="200"> 
...
<img src="./images/farmers_market_logical_model_partial.png" width="500"> 
...
- You can't diagram tables that don't share a common column
	...
	-  <img src="./images/farmers_market_conceptual_model.png" width="600"> 

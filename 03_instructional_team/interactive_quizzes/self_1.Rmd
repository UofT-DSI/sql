...
quiz(
  ...
  question("For PostalCode, which data type would be more restrictive?",
    answer("NVARCHAR"),
...
quiz(
  ...
  question("Suppose there were no primary or foreign keys at all. If you wanted to delete a Track from the database, how many tables would be affected by such a deletion?",
    answer("1"),
    answer("2", correct = TRUE),
    answer("3"),
    answer("5",),

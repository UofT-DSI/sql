...
quiz(
  ...
  ,allow_retry = TRUE
  ,random_answer_order = TRUE
  ,correct = "Correct! It's worth mentioning that `LIKE '%Mitch'` works with the current set of names, but might be wrong in the future, if a 'McMitch' or similar were hired!"
  ),
...
quiz(
  ...
  answer("`...CASE WHEN condition THEN result ELSE alternative_result END`", correct = TRUE),

...
*/
--QUERY 4
SELECT *, quantity*cost_per_quantity As price FROM customer_purchases
...
--QUERY 6
SELECT product_qty_type,product_name,
CASE
...
SELECT vendor_booth_assignments.market_date, vendor.vendor_name
FROM vendor
...
SELECT customer.customer_last_name,customer.customer_first_name, customer.customer_id, 
sum(quantity*cost_per_quantity) As total_spent FROM customer
...
(
10,
"Thomas Superfood Store", "Fresh Focused", "Thomas", "Rosrnthal"
);

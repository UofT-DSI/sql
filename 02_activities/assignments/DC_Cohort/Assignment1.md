...
This article shows that Pakistan’s national identity database is built around a specific idea of what a family should be. The system expects every person to fit into a traditional family structure with two married parents. This is not just a technical detail. It affects whether people can access important services like banking, voting, health care, or housing. The database ends up deciding which families are considered “real” and which are not. This creates problems for single mothers, orphans, LGBTQ+ people, and the khawaja sira community. When someone does not fit the system’s expectations, they may lose access to basic rights and support.
Reading this made me think about the data systems I interact with in daily life. Things like government ID forms, school registration, job applications, or banking apps also carry hidden assumptions. Many forms still ask for a mother and a father, which assumes a two-parent household. Medical forms often only list “male” or “female” when gender is more complex. University and workplace systems often separate “legal name” and “preferred name,” which can create stress for trans people or international students. Credit scoring systems assume a stable, traditional financial history, which disadvantages immigrants, students, or low-income families.
These systems often work smoothly only for people who already fit into the most common social patterns. People whose lives look different may experience extra steps, suspicion, or exclusion. Qadri’s article reminds us that databases are not neutral. The way they are designed reflects cultural values about what is “normal.” These values shape whose identity is recognized and whose is questioned.
I realize that convenience in data systems often comes at the cost of flexibility. When the system values efficiency and verification, it may ignore the complexity of real human lives. Once a database is built with strict categories, it is very difficult to change later. This is why it is important to include ethical and social thinking in system design, not only technical thinking.
A more thoughtful approach would be to design systems that can adapt to different situations and family structures. Systems should support how people actually live, instead of forcing people to fit into a narrow model. The article shows that the design of a database can shape people’s access to society. Because of this, database design should take diversity and fairness into account from the beginning.

...
Your thoughts...
```
Databases are created by humans and as digital architectural productions; they are inherently influenced by human subjectivity and the social contexts in which they are designed and exist. These contexts carry deeply embedded rules, norms, traditions, values, and constraints; a script for what’s approved vs what’s not. As a result, databases often reflect assumptions that may include biases, unfairness, and power dynamics. In my field, which focuses on mental health and specifically suicidality, this becomes especially apparent. In some regions where religion (and often misinterpretation of religion) and overarching cultural norms stigmatize suicide, deaths by suicide are often dismissed or misclassified as causes of death due to these social influences. For example, a footnote might inform the practitioner of the death, but the official cause may emphasize natural causes such as fatal heart injury from an overdose. Digital forms eliminate ‘unnatural’ causes, which may include suicide. Therefore, this design leads the system to overlook deaths by suicide, resulting in further stigma, significant underreporting, and misrepresentation of what is actually taking place within the society. 
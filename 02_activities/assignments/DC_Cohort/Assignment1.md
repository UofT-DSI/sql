...
```
One obvious embedded value of databases that deal with population data is the assumption that people can be categorized in stable and discrete ways. In practice, identity categories such as gender, ethnicity, or nationality may be fluid, contested, or context-dependent. For example, many government and institutional databases rely on rigid definitions of family structures. Forms often assume a traditional household model with clear relationships such as “mother,” “father,” or “spouse.” However, real families can be much more complex. Single-parent households, blended families, informal caregiving networks, and chosen families do not always fit easily into predefined categories. When databases enforce narrow definitions of relationships, they can unintentionally marginalize people whose lives do not conform to those structures. The article about Pakistan’s digital family database illustrates how technological systems can enforce a particular social vision of family, sometimes creating bureaucratic difficulties for individuals who do not match that model. Moreover, when database schemas require individuals to fit into a small set of predefined categories, they simplify complex social realities and can create biases on the outcome in a way that wrongfully put people into certain groups that are eitehr not representative of them and ends up inflating a certain group's stereotype or underestimante a group's contribution to society. 
Fairness and inequality also appear in the ways data is collected and used. Databases often reflect the priorities of institutions rather than the needs of the people represented in them. Decisions about which attributes to store—such as address, income, gender, or marital status—are influenced by political, cultural, and economic considerations. These choices can reinforce existing inequalities. For instance, algorithmic decision systems built on database records can reproduce biases present in historical data, affecting outcomes such as credit scoring, hiring, or policing.
```

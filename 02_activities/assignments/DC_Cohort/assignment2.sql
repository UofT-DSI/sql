...
/* 1) temp table for daily sales */
DROP TABLE if EXISTS temp.daily_sales;
CREATE TEMPORARY TABLE temp.daily_sales AS
SELECT 
	market_date,
...
VALUES (999, 'Apple Pie', '10 inch', 3, 'unit', CURRENT_TIMESTAMP);

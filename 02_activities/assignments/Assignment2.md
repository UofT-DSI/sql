...
```
Type 1: Overwrite. Customer_address: Customer_ID, Street, City, province, Postal_code
Type 2: Retain changes. customer_address: address_ID, Customer_ID, Street, City, province, Postal_code, Start_date, end_date
```

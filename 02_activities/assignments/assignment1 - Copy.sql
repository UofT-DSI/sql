...
FROM customer_purchases
WHERE vendor_id = 8 AND vendor_id = 9 AND vendor_id = 10
ORDER BY vendor_id
...
SELECT vendor_id,
COUNT (booth_number) AS total_boooth_rented
...
-- this was not requested to complete as during the lecture#3 we did not review it

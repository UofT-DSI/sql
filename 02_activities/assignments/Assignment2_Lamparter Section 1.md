...
```
Type 1 will overwrite changes while type 2 will retain changes. Type 1 is useful to fix a typo for example, while type 2 is useful to track history. We'd use type 2 because it's important to have for auditing purposes and thorough sales records.

...
SELECT *,
'price' as [quantity * cost_to_customer_per_qty]

FROM customer_purchases
WHERE
customer_id > 7 AND customer_id < 19;
...
SELECT 
    *,
    CASE 
        ...
        ELSE 'bulk'
    END AS prod_qty_type_condensed_name
FROM product;
...
ORDER BY v.vendor_name, market_date;
...
SELECT COUNT(vendor_id) as numb_of_assignments

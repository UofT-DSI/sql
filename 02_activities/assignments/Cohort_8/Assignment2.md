...
```
See assignment2_erd_logic.png. Relationships are indicated by line connectors, where || means one and the branched symbol means many. PK = primary key, FK = foreign key. Table and relationship additions for Prompt 2 are indicated in red. Table and relationship additions for Prompt 3 are indicated in blue.
```
#### Prompt 2
...
Table and relationship additions for Prompt 3 implementation of Type 2 approach to managing slowly changing dimensions (SCDs) are indicated in blue.
```

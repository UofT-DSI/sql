...
--QUERY 8
SELECT vendor_id
,COUNT(vendor_id) AS booth_rental_frequency
...
ROUND(SUM(cp.quantity*cp.cost_to_customer_per_qty), 2) as total_spend_over_2000
FROM customer as c
INNER JOIN customer_purchases as cp
	ON c.customer_id = cp.customer_id
GROUP BY c.customer_id
HAVING total_spend_over_2000 >= 2000
ORDER BY upper(c.customer_last_name) ASC, c.customer_first_name ASC;

...
--QUERY 1
SELECT *  -- this will give everything (will read whole table.
FROM customer;
--END QUERY
...
SELECT *
FROM customer
ORDER BY customer_last_name, customer_first_name  -- only first and last name
...
WHERE product_id IN (4, 9)  -- only for prodcut with id number 4 & 9

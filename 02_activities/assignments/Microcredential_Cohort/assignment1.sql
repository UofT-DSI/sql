...
market_date,
booth_number,
vba.vendor_id as vba_vendor_id
...
customer_first_name,
customer_last_name,
SUM(CAST(quantity*cost_to_customer_per_qty AS INTEGER)) AS spent,
c.customer_id,
cp.customer_id as cp_customer_id
FROM customer as c
INNER JOIN customer_purchases as cp
	ON c.customer_id = cp_customer_id

...
SELECT *
FROM vendor v
INNER JOIN vendor_booth_assignments v_b
    ON v.vendor_id = v_b.vendor_id
ORDER BY v_b.market_date, v.vendor_name
LIMIT 24;
...
SELECT
    vendor_id,
    COUNT(*) AS booth_assignment_times
FROM vendor_booth_assignments
GROUP BY vendor_id
ORDER BY booth_assignment_times DESC;
...
SELECT
    customer_id,
    SUM(quantity * cost_per_quantity) AS total_spent_april_2022
FROM customer_purchases

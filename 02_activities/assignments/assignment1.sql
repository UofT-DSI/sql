...
-- First create the temp table from the original vendor table
...
HINT: you might need to search for strftime modifiers sqlite on the web to know what the modifiers for month 
and year are! */
SELECT customer_id,

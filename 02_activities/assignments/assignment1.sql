/* ASSIGNMENT 1 */
/* SECTION 2 */
/* Joseph (Yunho) Yang DSI Cohort 6 jsph.yang@gmail.com
...
SELECT vendor_id, count(vendor_id) AS booth_rental_count
...
customer_first_name, 
customer_last_name, 
SUM(quantity*cost_to_customer_per_qty) AS grand_total
FROM customer c

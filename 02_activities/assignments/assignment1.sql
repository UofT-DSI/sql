...
sorted by customer_last_name, then customer_first_ name. */
	   ...
	   -- note: this will sort THEN take the first 10. 

	   -- If I want to take the first 10 THEN sort, I'd need  a subquery

	   -- Since this came before the subquery session, I assume this is sufficient. 
...
/* 1. Write a query that returns all customer purchases of product IDs 4 and 9. */
	   ...
	   -- looks like nobody bought sweet potatos...
...
vendor_id field they both have in common, and sorts the result by vendor_name, then market_date. */
	   ...
	   -- note: the phrasing &quot;vendor&quot; to &quot;vendor_booth_assignments&quot; I'm assuming is

	   -- &quot;vendor_booth_assignments&quot; on the LEFT and &quot;vendor&quot; on the RIGHT
...
at the farmer’s market by counting the vendor booth assignments per vendor_id. */
	   ...
	   SELECT vendor_id, COUNT(booth_number) AS 'qty_of_booth_rental'

	   FROM vendor_booth_assignments

	   GROUP BY vendor_id

	   -- note: the way this is set up, two booths rented on the same day is counted as two
...
and year are! */
	   ...
	   CREATE TEMP TABLE purchase_date AS 

...
SELECT * FROM vendor;
INSERT INTO temp.new_vendor (vendor_name, store_type, owner_name, contact_info, market_id)
VALUES ('Thomass Superfood Store', 'Fresh Focused', 'Thomas Rosenthal', 'contact@thomassstore.com', 10);

...
-- Observation: No PRODUCT ID'S with 9 found
...
-- Observation: No Vendor ID'S with 9 and 10 found
...
-- Count of total rental vendor_id wise
...
-- Count of total rental each vendor_id and booth_number wise
...
SELECT 
    customer_id, SUM(quantity * cost_to_customer_per_qty) AS total_spent
FROM customer_purchases

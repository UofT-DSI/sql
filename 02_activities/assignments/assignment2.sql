...
FROM (
	...
	FROM customer_purchases) as rn
WHERE rn.custom_visit_index = 1;
...
SELECT
	*, 
	...
	) as customer_purchased_product_times
FROM customer_purchases;
...
VALUES 
(30, 'Stinky Tofu', '1 lbs', 1, 'unit', CURRENT_TIMESTAMP);

...
I use to manage everything from my schedule, transit, and grocery shopping to digital banking, cloud storage, and social media. The same is true for my professional routine—there has not been a single workweek without checking articles on PubMed or protein expression data on 
...
negative consequences. After reading the article “When Databases Get to Define Families,” I have come to appreciate further the fact that databases can also negatively impact social, political, and ethical issues.
...
I see how databases can be exploited to reinforce bias societal norms, for example, family structure, and promote discrimination. In Riz’s case, the database decides which familial relationships are recognized (e.g., only two-parent families), which can severely limit one’s 

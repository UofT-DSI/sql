...
You can start this section following _session 1_.
...
- I diagrammed the relationship between `customer` and `customer_purchases`
- <img src = "./images/assignment_one_q1.png" width='600'>

---

## Section 2:

You can start this section following _session 2_.
...
You can start this section following _session 3_.
...
ROUND(SUM(cp.quantity * cp.cost*to_customer_per_qty), 0) AS total_spent
FROM customer as c
...
STRFTIME('%m', market_date) AS purchase_month,
STRFTIME('%Y', market_date) AS purchase_year,
ROUND(SUM(quantity \* cost_to_customer_per_qty),0) AS total_spent
FROM customer_purchases

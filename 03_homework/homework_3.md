...
# AGGREGATE
1. Write a query that determines how many times each vendor has rented aInsert the original vendor table into  booth at the farmer’s market by counting the vendor booth assignments per `vendor_id`.

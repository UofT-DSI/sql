...
- Have a 2 year old Samoyed named Alto who takes up a lot of my free time `r structure("\U1F449", class = "emoji")`
]

.pull-right[

<img src="imgs/dorky_alto.png"
     height="500px"
...
- Recently graduated from UofT with majors in Computer Science and Statistics, Minor in Mathematics
  - Held co-op positions at different banks
      - Citi (Software Development)
      - Bank of Montreal(Business Analytics) 
- Now working full-time at RBC Capital Markets in their Quant and Tech Services division
  - Currently a Business Systems Analyst (position is a cross between SDE and BA) 
  -  Working with salesforce CRM backend data in SQL server
  - Moving to a more technical role in a new team (Supervisory and Regulatory controls) next week (for my next rotation)
- Outside of work, strongly believe in advocating for the representation of women in tech 
  - Was the president of Women in Computer Science at UofT for 2 years
  - Now getting involved with Toronto Wxmen in Data Science and RWomen (RBC's women in tech ERG)

]

.pull-right[

<img src="imgs/DSC00461.png"
     height="500px"
     style="position:absolute; right:100px; top:130px;">
...
# About Me
.pull-left[
- Undergrad from Paris-Saclay University in Applied Mathematics and Data Science
- Discovered SQL, Python and R in an academic setting, and played with them in the industry after.
- A few internships in Machine Learning and Data Science:
  - Docugami (Incoming Research Scientist)
  - Ekimetrics (Data Scientist)
  - Stellantis (ML Engineer)
  - Randstad (ML Enginner)
- Currently pursuing the MscAC program at UofT - in the AI concentration
- Working on a lot of cool stuff at the intersection between Data Science and LLMs - very exciting but also a very fast-paced environment!
- Considering pursuing a PhD after to become a full-time professor `r structure("\U1F913", class = "emoji")`
- On my free time : play guitar, saxophone & bass and have been part of a few music bands `r structure("\U1F3B7", class = "emoji")`
]

.pull-right[

<img src="imgs/photo_5963.png"
     height="500px"
     style="position:absolute; right:100px; top:130px;">
...
Previously, A was an instructor at DSI (python) _and_ a TA at DSI (SQL). Thomas remains the instructor for SQL. Ananya is now the TA. If a table contained Employee ID and Employee Type ID, A would be listed twice.
...
**Q3)**
The store wants to keep customer addresses. Propose two architectures for the CUSTOMER_ADDRESS table, one that will retain changes, and another that will overwrite. Which is type 1, which is type 2? *Hint, search type 1 vs type 2 slowly changing dimensions*. 

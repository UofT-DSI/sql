...
- Reluctant Data Scientist (*do we even need this model?*) 
  - Currently doing Data Governance and Ethics implementation at Dataiku
...
- Please download/fork the FarmersMarket.db from our GH repo:
  - [https://github.com/UofT-DSI/sql/tree/main/05_sql](https://github.com/UofT-DSI/sql/tree/main/05_sql)
